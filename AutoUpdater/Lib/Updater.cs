...
namespace AutoUpdater
{
    public class Updater
    {
        ...
        public static void CheckUpdateStatus()
        {
            ...
            {
                string url = "http://127.dev.cnki.net/File/App/app.xml";
        ...
        public void StartUpdate(UpdateInfo updateInfo)
        {
            ...
            info.Arguments = "update " + CallExeName + " " + updateFileDir + " " + appDir + " " + updateInfo.AppName + " " + updateInfo.AppVersion.ToString();// + " "; + (string.IsNullOrEmpty(updateInfo.Desc) ? "" : Convert.ToBase64String(System.Text.Encoding.UTF8.GetBytes(updateInfo.Desc)));
